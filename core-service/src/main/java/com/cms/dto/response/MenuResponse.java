...
public class MenuResponse {
    ...
    private java.util.List<MenuResponse> children;
    ...
    public java.util.List<MenuResponse> getChildren() { return children; }
    public void setChildren(java.util.List<MenuResponse> children) { this.children = children; }
}
